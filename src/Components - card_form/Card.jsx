...
function Card({user, handleRemove, id}) {
  return (
    <div className='w-[32vh] h-full bg-zinc-100 rounded-lg flex flex-col items-center p-2'>
      ...
      <h1 className='mt-1 text-xl font-semibold text-center'>{user.name}</h1>
        ...
        <p className='mt-1 text-center text-xs font-semibold leading-1 tracking-tight'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Obcaecati inventore commodi quibusdam?</p>
